...
BeforeAll {
    Import-Module (Join-Path $PSScriptRoot '../../Modules/Freer.Scaffold/Freer.Scaffold.psd1')
...
Describe 'Mount-Scaffold' {
    ...
    AfterEach {
        Remove-Item $Env:SCAFFOLD_HOME -Recurse -Force -Exclude fthtml-base.scaffold
        Get-ChildItem $PSScriptRoot -Force -Exclude .scaffolds, Freer.Scaffold.Tests.ps1 | Remove-Item -Force -Recurse -ErrorAction Ignore
    }
